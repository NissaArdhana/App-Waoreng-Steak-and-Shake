    ...
    <div class="app-body">
      ...
      <div class="app-form">
        <div class="form-header">
          <div class="app-brand"><span class="highlight">Waroengsteak</span> Admin</div>
        </div>
        ...
        <div class="form-footer">
            ...
            <?php
                if(@$_GET["user"]=="wrong"){
                    echo "<br><br><font color='red'><br>ID. User dan Password yang anda masukkan salah!</br></font>";
                }
            ?>
        </div>
      </div>
