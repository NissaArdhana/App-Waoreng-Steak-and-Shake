...
<div class="wrapper">
  ...
  include "sistem/koneksi.php";
  $no = 1;
  $query = "SELECT * FROM tb_home"; // Query untuk menampilkan semua data siswa
  $sql = mysql_query($query); // Eksekusi/Jalankan query dari variabel $query
  ...
  while ($data = mysql_fetch_array($sql)){ // Ambil semua data dari hasil eksekusi $sql
    ...
    echo "<td><a href='ubah_index.php?id=".$data['id']."'>Ubah</a></td>";
    echo "<td><a href='sistem/delete_index.php?id=".$data['id']."'>Hapus</a></td>";
    echo "</tr>";
  }
  ?>
