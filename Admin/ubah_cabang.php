    ...
    <!-- Content Header (Page header) -->
      <!-- Main row -->
			...
			<?php
					  ...
					  ?>
            <div class="box-body">
              <form action="sistem/simpan_ubah_cabang.php?id=<?php echo $id; ?>" method="post" enctype="multipart/form-data">
			  <div class="form-group">
                  <input type="text" class="form-control" name="nama_cabang" value="<?php echo $data['nama_cabang']; ?>">
                </div>
                <div class="from-group">
                  <input type="text" class="from-control" name="alamat" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;" value="<?php echo $data['alamat']; ?>">
                </div>
				<div class="form-group">
                  <input type="text" class="form-control" name="telp" value="<?php echo $data['telp']; ?>">
                </div>		
				<div class="form-group">
                  <input type="text" class="form-control" name="Waktu_Buka" value="<?php echo $data['waktu_buka']; ?>">
                </div>	
				<div class="form-group">
                  <input type="text" class="form-control" name="Waktu_Tutup" value="<?php echo $data['waktu_tutup']; ?>">
                </div>
				<div class="form-group">
