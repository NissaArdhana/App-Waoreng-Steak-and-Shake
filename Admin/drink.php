...
<div class="wrapper">
    ...
    <!-- Content Header (Page header) -->
      <!-- Main row -->
            <div class="box-header">
              ...
              <h3 class="box-title">Drink</h3>
            </div>
            <div class="box-body">
              <form action="sistem/simpan_drink.php" method="post" enctype="multipart/form-data">
                <div class="form-group">
                  <input type="text" class="form-control" name="judul" placeholder=" Masukkan judul ">
                </div>
                <div>
                  <textarea class="textarea" name="isi" placeholder=" Masukkan Isi" style="width: 100%; height: 125px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"></textarea>
                </div>
				<div class="form-group">
                  <label>Gambar</label>
  ...
  while ($data = mysql_fetch_array($sql)){ // Ambil semua data dari hasil eksekusi $sql
    ...
    echo "<td><a href='ubah_drink.php?id=".$data['id']."'>Ubah</a></td>";
    echo "<td><a href='sistem/delete_drink.php?id=".$data['id']."'>Hapus</a></td>";
    echo "</tr>";
  }
  ?>
